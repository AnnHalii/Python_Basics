...
class Game:
	def __init__(self):
		...
		self.sprites = []
		self.running = True
		self.game_over_text = self.canvas.create_text(250, 250, text='Победа!', font=('Times', 30), state='hidden', fill='green')
		self.out = self.canvas.create_text(58, 22, text='Выход', font=('Times', 7), fill='green')
...
class StickFigureSprite(Sprite):
	def __init__(self, g):
		...
		g.canvas.bind_all('<KeyPress-Up>', self.jump)
...
games = Game()
form1 = MovingPlatformSprite(games, PhotoImage(file = "resources/platform1.gif"), 0, 480, 100, 10)
...
form5 = MovingPlatformSprite(games, PhotoImage(file = "resources/platform2.gif"), 175, 350, 66, 10)
